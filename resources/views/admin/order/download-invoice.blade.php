                        ...
                        <div class="invoice-box">
                            <table cellpadding="0" cellspacing="0">
                                <tr class="top">
                                    <td colspan="4">
                                        <table>
                                            <tr>
                                                <td class="title">
                                                    <img src="{{asset('/')}}website/assets/img/logo.png" style="width: 100%; max-width: 300px"/>
                                                </td>
                                                <td>
                                ...
                                <tr class="item">
                                    ...
                                    <td style="text-align: center;">{{$orderDetails->product_price}}</td>
                                    <td style="text-align: center;">{{$orderDetails->product_qty}}</td>
                                    <td style="text-align: right;">{{$orderDetails->product_qty * $orderDetails->product_price}}</td>
                                </tr>
                                ...
                                <tr class="total">
                                    <td colspan="3"></td>
                                    <td>Shipping Total: {{$order->shipping_total}}</td>
                                </tr>
                                <tr class="total">
                                    <td colspan="3"></td>
